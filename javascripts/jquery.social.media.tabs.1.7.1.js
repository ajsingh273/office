		...
		create: function(el, options) {
			...
			this.defaults = {
				...
				delicious: {
					...
					limit: 10,
					icon: 'images/delicious.png'
				},
				digg: {
					title: 'Latest Diggs',
					link: false,
					limit: 10,
					icon: 'images/digg.png',
					hdrBg: "#ececec", 
					hdrTxt: "#555", 
					tabBg: "#4684be", 
					tabTxt: "#b3daff", 
