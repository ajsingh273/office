		...
		* Stream Load Events
		...
		function tabCallback(streams){
			...
			var tabList = ['<li class="All"><a href="#" class="active"><span>All</span></a></li>'];
				...
				$thisObj.append('<div class="dataContainer" style="height:'+o.theme.shell.height+'px;"></div><span class="Q4Footer"><a href="http://q4websystems.com" target="_blank">Powered By Q4 Web Systems</a></span>');

				$('<ul />', {
					"class": "tabHeader",
					html: tabList.join('')
				}).prependTo($thisObj).wrap('<div class="HeaderContainer" />').before('<div class="WidgetTitle"><a href="'+o.clientHrefLogo+'" target="_blank" class="ClientLogo"></a><h1>' + o.widgetTitle + '</h1></div><a href="http://q4websystems.com" target="_blank" class="Q4Logo"></a>');
